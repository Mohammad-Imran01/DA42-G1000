...
Item
{
    property int varVSI:0
    Image
    {
        id: pRVSI;
        source: "qrc:/custom/images/RSVI.png";
        x:- widthRVSIstart
    ...
    {
        id: pbugVSI;
        source: "qrc:/custom/images/N1Bug2.png";
        x:0
    ...
    Repeater
    {
        ...
        Item {
            ...
            Text {
                visible: (index%2==0 && index!=4) ? true:false
                x: widthVSIt //23
    ...
    {
        id:arrows
        y:- varVSIValueY/ scaleVSIarow  //Esmaeili
